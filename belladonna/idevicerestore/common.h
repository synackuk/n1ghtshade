...
typedef int (*ibss_hook_t)(struct idevicerestore_client_t* client, void* to_load, size_t load_len);
typedef int (*hook_t)(struct idevicerestore_client_t* client);
...
typedef int(*info_cb_t)(const char* format, ...);
typedef int(*error_cb_t)(const char* format, ...);
typedef int(*debug_cb_t)(const char* format, ...);
